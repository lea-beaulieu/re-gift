...
router.post("/signup", fileUploader.single('image'), (req, res, next) => {
  ...
  // Validation mandatory fields (all but avatar)
  if ( !firstname || !lastname || !username )  {
    res
      .status(400)
      .render("auth/signup", { errorMessage: "Please enter all the mandatory fields." });
    return;
  ...
  bcrypt
    ...
    .then(hashedPassword => {
      ...
      return User.create({
        ...
        city,
        zip, 
        avatar: req.file && req.file.path || "https://res.cloudinary.com/hkxgywr9f/image/upload/v1641176282/Regift/avatar_wsl513.jpg"
      });
    })
    .then(userFromDB => {
